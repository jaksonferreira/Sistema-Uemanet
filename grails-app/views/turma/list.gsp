			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="turma.tutor.label" default="Tutor" /></th>
				...
				<g:each in="${turmaInstanceList}" status="i" var="turmaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${turmaInstance.id}">${fieldValue(bean: turmaInstance, field: "curso")}</g:link></td>
					
						<td>${fieldValue(bean: turmaInstance, field: "tutor")}</td>
